...
public class JFrameProgramador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAdc.setBackground(new java.awt.Color(51, 51, 51));
        btnAdc.setText("+");
        btnAdc.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnMult.setText("X");
        btnMult.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(btnAdc, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnMult, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnAdc, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIgualActionPerformed
        // TODO add your handling code here:
        // Obtém a expressão do campo de texto
    String expressao = jTextAreaSaida.getText();
    
    
    // Verifica se a expressão contém um operador
    if (!expressao.contains("+") && !expressao.contains("-") && !expressao.contains("*") && !expressao.contains("/")) {
        JOptionPane.showMessageDialog(null, "Digite um número e escolha uma operação", "Erro", JOptionPane.ERROR_MESSAGE);
        return;
    }
        // permitindo apenas uma operação por vez.
    String[] partes = expressao.split("(?<=[-+*/])|(?=[-+*/])");
    if (partes.length != 3) {
        JOptionPane.showMessageDialog(null, "Expressão inválida.", "Erro", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    int valor2 = Integer.parseInt(partes[2].trim());
    ...
    jTextFieldDec.setText(String.valueOf(resultado));
    jTextFieldHex.setText(calculadora.DecToHex(resultado));
    jTextFieldBin.setText(calculadora.DecToBin(resultado));
    jTextFieldOct.setText(calculadora.DecToOctal(resultado));
